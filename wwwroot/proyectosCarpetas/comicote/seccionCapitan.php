            ...
            <section class="row">
                ...
                <section class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <section class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-2 col-lg-2">
                            <img src="/Practica 4/img/joker.jpg" class="img-fluid">
                        </div>
                ...
                <section class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <section class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-2 col-lg-2">
                            <img src="/Practica 4/img/dosCaras.jpg" class="img-fluid">
                        </div>
                        <div class="col-12 col-sm-12 col-md-10 col-lg-10">
                ...
                <section class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-2 col-lg-2">
                        <img src="/Practica 4/img/largoHalloween.jpg" class="img-fluid">
                    </div>
                    <div class="col-12 col-sm-12 col-md-10 col-lg-10">
                    ...
                    <div class="col-12 col-sm-12 col-md-2 col-lg-2">
                        <img src="/Practica 4/img/BromaAsesina.jpg" class="img-fluid">
                    </div>
                    <div class="col-12 col-sm-12 col-md-10 col-lg-10">
