            ...
            <section class="col-lg-12 col-md-12 col-sm-12 col-12">
                <section class="row">
                    ...
                    <section class="col-lg-8 col-md-8 col-sm-12 col-12" id="textoDescripcion">
                        ...
                        <b id="autores">Jason Aaron, Jesús Saiz, Paul Azaceta </b><br>
                        <b id="etiquetas">Editoriales</b>
                        <b id="autores">Panini Comics</b>
                        <p>
                            Frank Castle está determinado a utilizar a La Mano para poner fin a su guerra. Pero los
                            Apóstoles de Guerra se niegan a que tal cosa ocurra. El Castigador nunca ha tenido enemigos
                            más duros. Y eso sin mencionar a Lady Bullseye y a Dama Mortal, contratadas para derrocar a
                            Frank como líder de La Mano.
                        </p>
