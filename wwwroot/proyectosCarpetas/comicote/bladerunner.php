            ...
            <section class="col-lg-12 col-md-12 col-sm-12 col-12">
                <section class="row">
                    ...
                    <section class="col-lg-8 col-md-8 col-sm-12 col-12" id="textoDescripcion">
                        ...
                        <b id="autores">Andrés Guinaldo, Marco Lesko, Mike Johnson </b><br>
                        <b id="etiquetas">NORMA Editorial</b>
                        <b id="autores">NORMA Editorial </b>
                        <p>LLEGA LA CONCLUSIÓN DE ESTA NUEVA AVENTURA INSPIRADA EN LA PELÍCULA DE RIDLEY SCOTT</p>
                        <p>Los Ángeles, 2029. La ciudad está bajo asedio del ejército de replicantes mejorados de Yotun.
                            Su muralla marítima ha sido hecha pedazos, la torre del departamento de policía ha ardido
                            hasta los cimientos, y en las calles reina el caos, con numerosos replicantes rebelándose
                            contra sus propietarios humanos.
                        </p>
                        <p>Mientras tanto, la Blade Runner Aahna Ashina ha conseguido reunirse con Freysa, su pareja
                            replicante, pero también ha acabado convirtiéndose en sospechosa de la división Blade
                            Runner. El tiempo empieza a acabársele a Ashina, que lucha desesperadamente para detener a
